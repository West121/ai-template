...
import com.hentor.oa.workflow.notify.NotifyDispatcher;
import com.hentor.oa.workflow.notify.NotifyMessage;
 ...
 */
@com.hentor.oa.common.script.ScriptApi("工作流审计/站内通知：notify(用户id,类型,标题,内容,流程实例id) 发站内通知；op 记操作留痕")
@Component
