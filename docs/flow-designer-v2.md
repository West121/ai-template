...
> ⚠️ **本文部分内容已被取代（2026-07-09）**：设计器方向已定为「用 react-flow 自研 BPMN 设计器替换 bpmn-js」，最新架构以 **`docs/design/next-gen-workflow-and-formula.md`** 为准。本文关于"BPMN 设计器为演示态/主力设计器"的表述已过时，属性面板/校验/按钮白名单等仍可参考。
>
