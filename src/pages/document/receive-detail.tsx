      ...
      <div className="grid gap-4 lg:grid-cols-5">
        ...
        <div className="space-y-4 lg:col-span-2">
              ...
              <div className="border-b px-4 pt-3">
                <TabsList>
                  <TabsTrigger value="timeline">
                    办理时间线
                    {doc.opinions?.length ? (
                      <span className="ml-1 text-xs text-muted-foreground">({doc.opinions.length})</span>
                    ) : null}
                  </TabsTrigger>
                  <TabsTrigger value="circulation">
                    传阅单
                    {circCount ? <span className="ml-1 text-xs text-muted-foreground">({circCount})</span> : null}
                  </TabsTrigger>
                </TabsList>
              </div>
          ...
          {doc.content && (
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm">来文正文</CardTitle>
              </CardHeader>
              <CardContent>
                <div
        ...
        <div className="lg:col-span-3">
          ...
          <p className="mt-2 text-center text-xs text-muted-foreground">来文原件版式预览（GB/T 9704）</p>
        </div>
      </div>
    </div>
  )
